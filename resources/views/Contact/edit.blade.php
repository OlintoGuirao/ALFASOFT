...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('contact/' .$contacts->id) }}" method="post">
        ...
        <input type="text" name="Email" id="Email" value="{{$contacts->mobile}}" class="form-control"></br>
        <label>CPF</label></br>
        <input type="text" name="cpf" id="cpf" value="{{$contacts->mobile}}" class="form-control"></br>
